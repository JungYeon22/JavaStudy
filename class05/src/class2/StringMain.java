...
public class StringMain {
    public static void main(String[] args) {
        ...
        System.out.println("부분 문자열 추출 : "+ e.substring(7,11));          // 인덱스 7번부터 11번 이전!(7~10)

        System.out.println("대문자 변경 : " + "Hello".toUpperCase());        // 검색 처리할때 한쪽으로 바꾸고 검색
...
/*
new 로 만들면 메모리에 생성 , 원래 있던 객체라도 또 생성

23번째 줄 : 문자열은 편집이 안되므로 메모리 4번 생성된다.
